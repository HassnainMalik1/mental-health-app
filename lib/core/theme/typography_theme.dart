...
extension CustomTextTheme on TextTheme {
  TextStyle get mentalLargeTitle {
    return TextStyle(fontSize: 34.0, height: 1.2, fontFamily: 'Inter');
  }

  TextStyle get mentalTitle {
    return TextStyle(fontSize: 27.0, height: 1.2, fontFamily: 'Inter');
  }

  TextStyle get mentalTitle2 {
    return TextStyle(fontSize: 20.0, height: 1.2, fontFamily: 'Inter');
  }

  TextStyle get mentalHeadline {
    return TextStyle(fontSize: 17.0, height: 1.2, fontFamily: 'Inter');
  }

  TextStyle get mentalBody {
    return TextStyle(fontSize: 15.0, height: 1.2, fontFamily: 'Inter');
  }

  TextStyle get mentalCaption {
    return TextStyle(fontSize: 13.0, height: 1.2, fontFamily: 'Inter');
  }

  TextStyle get mentalCaption2 {
    return TextStyle(fontSize: 11.0, height: 1.2, fontFamily: 'Inter');
  }
